...
ggsave("static/el_ex1.png", pp, width = 7, height = 5)
```
...
ggsave("static/tel_ex2.png", pp, width = 7, height = 5)
```
...
p <- ggplot(cumulative, aes(x = Componenti, y = value)) +
  ...
  theme_minimal()
print(p)
ggsave("static/tel_pca.png", p, width = 7, height = 5)
...
ggsave("static/Loadings.png", p, width = 7, height = 5)
```
## Clustering
...
print(p)
ggsave("static/C1_C2.png", p, width = 7, height = 5)
```
...
ggsave("static/C_SHAPE__IN_OUT__GP.png", p, width = 7, height = 5)
```
...
p1 <- ggplot(data = tel.comp, mapping = aes(x = TRACK, y = C_SHAPE, color = factor(labs))) +
  ...
  theme_minimal()
print(p1)
ggsave("static/C1_C4_R.png", p1, width = 7, height = 5)
