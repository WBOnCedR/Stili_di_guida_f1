...
p <- ggplot(loadings_long, aes(x = component, y = Variable, fill = abs(peso))) +
  geom_tile(color = "white") +
  geom_text(aes(label = round(abs(peso), 2)), size = 2.5, color = "black")+
  scale_fill_gradient(low = "white", high = "#E10600", name = "Pesi") +
  theme_minimal() +
  labs(x = "Componenti",
       y = "Variabili") 
...
#ggsave("Loadings.pdf", p, width = 7, height = 5, device = cairo_pdf)
```
## Clustering
...
print(p)
ggsave("C1_C2.pdf", p, width = 7, height = 5, device = cairo_pdf)
