...
```{r}
rm(list=ls())
setwd("C:/Users/4erre/Documents/PERSONALE/SCUOLA/A.A._2025-2026/Statistica_computazionale/Progetto")
options(warn = -1) 
...
```{r}
tel <- readRDS("C:/Users/4erre/Documents/PERSONALE/SCUOLA/A.A._2025-2026/Statistica_computazionale/Progetto/formula1/data/dataset_completo_best_tel.rds")
head(tel)
tel <- as_tibble(tel)
```
