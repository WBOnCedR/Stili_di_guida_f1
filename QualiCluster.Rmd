...
tel.guida <- tel.guida %>%
  ...
  select(GP,pilota,throttle,acc_x,acc_y,time) %>% 
...
tel.guida_summary <- tel.guida_summary %>%
  ...
  select(-throttle_max,-throttle_min, )
```
...
relevant <- c(
  ...
  "acc_y_mean",
  "acc_y_sd",
  "throttle_lag2_mean_neg",
  "throttle_lag2_sd_pos",
  "acc_x_lag1_sd_neg",
  "acc_x_lag3_sd_pos",
  "acc_y_lag1_mean_neg",
  "acc_y_lag2_sd_pos"
...
plot(clust, what = "BIC", ylim = c(-1000, 3000), legendArgs = list(x = "topleft"))
