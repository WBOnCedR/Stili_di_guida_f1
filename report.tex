...
\begin{document}
	...
	Al fine di rendere confrontabili i diversi tracciati dei Gran Premi, la variabile di accelerazione laterale viene riscalata\footnote{Estratto codice R consultabile nell'appendice \ref{codice trattamento e creazione variabili}.\label{appendice 3}}, per ciascun Gran Premio e Pilota, nell'intervallo $[-1,1]$. Successivamente, viene trasformata tramite valore assoluto, così da ottenere una misura dell'intensità complessiva (magnitudo), il supporto quindi risulta compreso in $[0,1]$.
