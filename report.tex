...
\begin{document}
	...
	\begin{center}
		\begin{tabular}{lll}
			...
			Accelerazioni laterale e longitudinale         & $\mathrm{m/s^2}$    & \texttt{numeric} \\
	...
	\begin{wrapfigure}{r}{0.5\textwidth} % {r} sta per destra (right), 0.5 è la larghezza
		\centering
		\includegraphics[width=.5\textwidth]{tel_ex1.pdf}
	...
	Per le misure di accelerazione longitudinale e laterale vengono calcolate media, deviazione standard, valore massimo e valore minimo. Per la variabile relativa alla frenata, di natura dicotomica non categorica, vengono invece considerate esclusivamente la media e la deviazione standard, poiché il calcolo di minimo e massimo non risulta informativo.
	Anche per la variabile accelerazione non si calcolano gli estremi in quanto una misura limitata nell'intervallo [0-100], e risulterebbero costanti per tutti i piloti e gran premi.
	...
	Il nuovo dataset pertanto contiene 52 variabili, che forniscono informazione sullo stile di guida del pilota nella specifica gara.
