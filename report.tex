...
\begin{document}
	...
	\begin{enumerate}
		...
		\item La quinta componente è dominata dalla dinamica laterale, con contributi rilevanti delle accelerazioni laterali con lag positivi,sono incluse anche variabili legate all’acceleratore con lag positivi.
		La componente può quindi essere interpretata come descrittiva di fasi di guida caratterizzate da una dinamica laterale sostenuta e prolungata.
		Valori elevati sono associati a una maggiore variabilità laterale persistente, mentre valori bassi indicano una dinamica laterale più contenuta e regolare.
