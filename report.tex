...
\begin{document}
	...
	Sempre per quanto riguarda la variabile tempo giro, dato il fatto che per regolamento della \textbf{FIA}(\href{https://www.fia.com/sites/default/files/fia_2025_formula_1_sporting_regulations_-_issue_1_-_2024-07-31.pdf}{39.4.b.i ; PAG:47}) un pilota se supera il $107\%$ del tempo giro minore viene escluso dalle qualifiche.	Si applica questo filtro al dataset, emergono come outlier i piloti Hamilton, Tsunoda, Antonelli, Albon e Bortoleto nel GP di Las Vegas e Stroll nel GP d'Olanda.
