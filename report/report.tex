...
\begin{document}
	...
	\section{Model Based Clusering with Covariates}
	...
	Per far ciò si applica un $MEM$ (\texttt{Mixture of Experts Models}), utilizzando una regressione normale multivariata con variabili :
	\begin{itemize}
