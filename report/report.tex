...
\begin{document}
	...
	Come illustrato nella Figura \ref{fig:c_shape_in_out_gp}, la distribuzione dei Gran Premi nelle prime due componenti principali evidenzia chiaramente la separazione tra le diverse classi identificate.
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=.6\textwidth]{C_SHAPE__IN_OUT__GP.pdf}
	...
	\begin{itemize}
		...
		\item \textbf{Esplicativa} $\begin{bmatrix}
								...
								\end{bmatrix}$;
	\end{itemize}
	La Figura \ref{fig:reg14} mostra la relazione tra la componente TRACK e IN\_OUT per ciascun cluster, evidenziando come il modello di regressione catturi l'influenza del tracciato sullo stile di guida.
	...
	\begin{figure}[H]
		...
		\begin{minipage}{0.48\textwidth}
			\centering
			\includegraphics[width=\textwidth]{C1_C4_R.pdf}
			\caption{IN\_OUT VS TRACK}
			\label{fig:reg14}
		\end{minipage}
		\hfill % Spazio elastico tra le due minipage
		% Seconda figura (a destra)
		\begin{minipage}{0.48\textwidth}
			\centering
			\includegraphics[width=\textwidth]{newplot2.png}
	...
	\end{table}
	\subsection{Frequenza dei piloti nelle classi - Set 2}
