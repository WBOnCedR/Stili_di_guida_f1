...
\begin{document}
	...
	A sostegno delle ipotesi sopra citate, si riporta la Figura \ref{fig:confronto} che confronta nel Gran Premio degli USA le accelerazioni e velocità per i piloti: Charles Leclerc, Oliver Bearman, Max Verstappen e Franco Colapinto.
	\begin{figure}[H]
		\centering
		\includegraphics[width=\columnwidth]{tel_ex1.pdf}
		\caption{Accelerazioni VER, LEC, BEA, COL.}
		\label{fig:confronto}
	\end{figure}
